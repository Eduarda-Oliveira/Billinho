	...
	module V1
        class Api::V1::EnrollmentsController < ApplicationController   
            ...
            def show
                ...
                render json: {status: 'SUCCESS', message:'MatriculEnrollmenta loaded', data:enrollment}, status: :ok
            end
			...
			def update
				...
				if enrollment.update_attributes(enrollment_params)
					...
					render json: {status: 'ERROR', message:'Enrollment not update', data:enrollment.errors},status: :unprocessable_entity
				end
			end
             private
