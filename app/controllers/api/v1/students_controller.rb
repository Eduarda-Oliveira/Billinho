        ...
        class StudentsController < ApplicationController   
            ...
            def create 
                ...
                if student.save
                    ...
                    render json: {status: 'ERROR', message:'Aluno not saved', data:student.errors}, status: :unprocessable_entity
                end
            end 
             # Exclui student
			def destroy
			...
			def update
				...
				if student.update_attributes(student_params)
					...
					render json: {status: 'ERROR', message:'Aluno not update', data:student.errors},status: :unprocessable_entity
				end
			end
            # parametros aceitos
            private
